-- NateeHubb v3 | Universal Delta + Orion UI Hub
-- No key system
...
OrionLib:MakeNotification({
	Name = "NateeHubb",
	Content = "Loading Hub "..CURRENT_VERSION,
	Time = 3
})

-- SEA DETECTION
local Sea = "Unknown"
if game.PlaceId == 2753915549 then Sea = "First Sea"
elseif game.PlaceId == 4442272183 then Sea = "Second Sea"
elseif game.PlaceId == 7449423635 then Sea = "Third Sea" end
...
PlayerTab:AddSlider({
	Name = "WalkSpeed",
	Min = 16, Max = 300, Default = 16, Color = Color3.fromRGB(0,255,0),
...
PlayerTab:AddSlider({
	Name = "JumpPower",
	Min = 50, Max = 300, Default = 50, Color = Color3.fromRGB(0,255,0),
...
VisualsTab:AddToggle({
	...
	Callback = function(Value)
		FruitESP = Value
		if not Value then ClearFruitESP() end
	end
})
task.spawn(function()
